...
moduleForComponent('form/input/ef-datetime-local', 'Integration | Component | form/input/ef datetime-local', {
  integration: true
});

test('Default rendered state', function(assert) {
  this.render(hbs`
    {{form/input/ef-datetime-local}}
  `);
...
test('error state applies expected class', function(assert) {
  ...
  this.render(hbs`
    {{form/input/ef-datetime-local property="testProperty" errorStates=errorStates}}
  `);
